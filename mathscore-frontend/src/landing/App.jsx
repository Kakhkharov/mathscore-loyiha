        ...
        <nav className="hidden md:flex relative items-center bg-surface-container-high/40 p-1 rounded-full border border-outline-variant/20 shadow-[inset_0_1px_2px_rgba(0,0,0,0.05)] backdrop-blur-md">
          ...
          {navItems.map((item, index) => (
            <a
              ...
              href={item.href}
              className={`relative font-label-md text-[14px] px-5 py-1.5 z-10 transition-colors duration-300 rounded-full ${activeTab === item.name ? 'font-bold text-primary' : 'font-medium text-on-surface-variant hover:text-on-surface'
                }`}
            >
              {item.name}
            </a>
