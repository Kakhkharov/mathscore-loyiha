...
function App() {
  ...
  useEffect(() => {
    fetch('http://localhost:5001/api/settings', { cache: 'no-store' }).then(res => res.json()).then(data => setSettings(data)).catch(console.error);
    fetch('http://localhost:5001/api/results', { cache: 'no-store' }).then(res => res.json()).then(data => setResults(data)).catch(console.error);
    fetch('http://localhost:5001/api/pricing', { cache: 'no-store' }).then(res => res.json()).then(data => setPricing(data)).catch(console.error);
  }, []);
